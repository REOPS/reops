...
package com.realeyes.osmf.media
{
	 ...
	 */ 
	public class LightF4MLoader extends LoaderBase
	{
		/**
		 ...
		 *  @productversion OSMF 1.0
		 */ 	
		public function LightF4MLoader(factory:MediaFactory)
		{
			super();
		...
		/**
		 * Overrides the super class's canHandleResource method. Returns whether the
		 * passed in resource is supported or not. 
		 * @param resource - the media resource to check for support
		 * @private
		 */ 
