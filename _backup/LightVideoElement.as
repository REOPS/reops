...
/*	CONFIG::ENABLE_HTTP_AND_DRM
	...
	*/
	public class LightVideoElement extends LightweightVideoElement
	{
		/**
		 * Constructor.
		 * 
		 ...
		 *  @productversion OSMF 1.0
		 */
		public function LightVideoElement(resource:MediaResourceBase=null, loader:NetLoader=null)
		{
		...
		/**
		 * Overrides the super class's set resource function. Sets the appropriate loader
		 * up front and sets the super class's resource attribute equal to the value
		 * parameter
		 * @param value - the the resource for the LightVideoElement
		 * @private
		 **/
